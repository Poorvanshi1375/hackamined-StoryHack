...
import { editScene, getSceneVersions, setSceneVersion, imageUrl } from '../api.js'
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col gap-3 flex-1">
                  ...
                  >
                    {isLoading ? (
                      <span className="flex items-center gap-1">
                        <svg className="w-2.5 h-2.5 spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3}>
        ...
        {/* ── Title ── */}
        <h3 className="font-semibold text-gray-800 text-sm leading-snug">{vContent.title}</h3>
